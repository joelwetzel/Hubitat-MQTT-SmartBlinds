...
6. At this point, you MUST calibrate the buck converter to output 5V.  ![alt text](https://github.com/joelwetzel/Hubitat-MQTT-SmartBlinds/blob/master/BuckConverter5V.png)
